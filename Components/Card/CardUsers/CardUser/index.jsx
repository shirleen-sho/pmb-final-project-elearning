...
export default function CardUser({ value, index }) {
              ...
              <div className="relative">
                <div className="absolute top-0 right-5">
                  <div className="bg-white w-28 h-24 border rounded shadow px-4 ">
                    <Button type="link" link= {path + `/edit/`}><HiOutlinePencil className="absolute left-2 hover:text-primary-400" size={12}/>Edit</Button>
                    <Button type="link" link= {path + `/detail`}><HiOutlineDocumentText className="absolute left-2 hover:text-primary-400" size={12}/>Detail</Button>
